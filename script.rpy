...
label first_flowering:
    ...
    menu:
        "Tertarik! Bagaimana caranya? (investasi 50.000)":
            if money >= 50000:
                $ money -= 50000
                $ knowledge += 30
                $ reputation += 20
...
label beekeeping_start:
    ...
    $ money += 250000  # Monthly honey income
...
label flowering_continue:
    ...
    menu:
        "Pasang sistem irigasi tetes (mahal tapi efisien - 100.000)":
            if money >= 100000:
                $ money -= 100000
                $ knowledge += 25
...
label first_harvest_prep:
    ...
    $ harvested_beans += 50
    $ energy -= 40
    $ money += 750000  # Income from first harvest
    hide mahmud
